...
def filter_builtinIn_import(import_node):
    ...
    import_node.names = list(filter(is_builtin_module, import_node.names))
    ...
    def generate_ImportList(self):
        ...
        for mod in list(self.modules.values()):
            if mod.is_main_module:
                ...
                continue
            for alias, module_name in list(mod.dependent_modules.items()):
            ...
            import_list += list(mod.exported_functions.values())
        return import_list
